...
BioScout is a context-aware Android application for campus biodiversity exploration. It combines an image-derived candidate list with location, season, user-selected microhabitat and nearby Atlas of Living Australia occurrence records, then explains how those context cues change the final ranking.
