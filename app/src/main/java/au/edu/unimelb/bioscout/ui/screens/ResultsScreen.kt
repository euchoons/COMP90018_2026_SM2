...
import au.edu.unimelb.bioscout.ui.components.EvidenceBar
...
import au.edu.unimelb.bioscout.ui.components.RelativeScoreLabel
import au.edu.unimelb.bioscout.ui.components.SectionHeading
import au.edu.unimelb.bioscout.ui.components.SelectableCard
...
@Composable
private fun AnalysisProgressCard(state: BioScoutUiState, onRetryContext: () -> Unit) {
    Card(
